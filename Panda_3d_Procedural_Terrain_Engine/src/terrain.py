...
class Terrain(NodePath):
    ...
    def oldPreload(self, task, xpos=0, ypos=0):
        ...
        for x in range (int(xstart - checkRadius), int(xstart + checkRadius), self.tileSize):
            for y in range (int(ystart - checkRadius), int(ystart + checkRadius), self.tileSize):
    ...
    def makeNewTile(self):
        ...
        for checkX in range (int(xstart - checkRadius), int(xstart + checkRadius), self.tileSize):
            for checkY in range (int(ystart - checkRadius), int(ystart + checkRadius), self.tileSize):
